...
n <- 40 # Number of random selections
t0 = 1990
b = 2020
lp = 0.75
hp = 1.25
...
if (plot_params){
  ...
  ggsave(paste0("../model_graph/fit_simulation_fitted_results_", n, "_", t0, "_", lp*100, "-", hp*100, ".png"), width = 10, height = 6)
}
...
if (prediction) {
  prediction_n <- mapply(function(params, i, b) {
    ...
    # Convert the list of parameters to a numeric vector in the correct order
    params_vector <- unlist(params$par)
