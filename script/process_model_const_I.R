...
save_par_v1 = "../model_result/pars_v1-2_const.rds"
save_par_v2 = "../model_result/pars_v2_const.rds"
save_par_v3 = "../model_result/pars_v3-1_const.rds"
save_model_v1 = "../model/model_v1-2_const.rds"
save_model_v2 = "../model/model_v2_const.rds"
save_model_v3 = "../model/model_v3-1_const.rds"
...
loss <- function(params) {
  ...
  years <- t0:b
  I <- sapply(years, constant_growth, I0)
...
lower_bounds <- c(1, 0.000001, 0.000001)
upper_bounds <- c(1e6, 1, 1)
if(fit_v1){
  init_params <- c(I0 = 1000, pd = 0.1, pr = 0.2)
...
ggplot(pvo) +
  ...
  ggtitle("Prediction vs. Observation with Constant Growth Invasions (I)") +
  xlab("Year") +
  ylab("Number of invasions") +
  theme_bw() +
  guides(color = guide_legend(title = "Series"))
ggsave("../model_graph/pre_invasion_cons.png")
...
ggplot(pvo) +
  ...
  ggtitle("Change in Cumulative Recorded Invasions (F(b)) and Constant Growth Invasions (I)") +
  xlab("Year 'a'") +
  ylab("Value") +
  theme_bw() +
  guides(color = guide_legend(title = "Series"))
ggsave("../model_graph/cumu_pre_invasion_cons.png")
